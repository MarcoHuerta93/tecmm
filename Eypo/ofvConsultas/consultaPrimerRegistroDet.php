...
$cdoc = $_POST['cdoc'];
$cont = 0;
$sql = "SELECT * FROM Pruebas15nov16.dbo.IV_EY_PV_OfertasVentasDet ofvd
...
while ($Row = sqlsrv_fetch_array($consulta)) {
  ...
  echo $linea = '<tr>
                    ...
                    <td class="cantidad">' . number_format($Row['Quantity'], 2, '.', '') . '</td>
                    ...
                    <td class="comentario2">' . $Row['comentarioPartida2'] . '</td>
                    <td><a href="#" style="color: red" id="eliminarFila"><i class="fas fa-trash-alt"></i></a></td></tr>';
}
?>
