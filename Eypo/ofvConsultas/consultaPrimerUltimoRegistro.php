<?php
	...
	$ordenASC = $_POST['orden'];
	$sql = "SELECT TOP 1 vofv.Estatus as EstatusOFV, * FROM Pruebas15nov16.dbo.IV_EY_PV_OfertasVentasCab vofv
	LEFT JOIN dbEypo.dbo.ofertas ofv ON vofv.FolioSAP = ofv.DocNum	ORDER BY FolioSAP " . $ordenASC;
