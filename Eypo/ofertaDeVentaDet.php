<?php
   ...
   $na = $numArray - 1;
    ...
    for ($index=0; $index < $na ; $index++) {
      ...
      $sql = $sql."','".$comentario2[$index]."'";
       ...
       $consulta = "INSERT INTO dbEypo.dbo.ofertadet (DocNum, articulo, descripcion, cantidad, precioUnidad, descuento, impu, impuesto, total, almacen, cantidadPendiente, codigoPlanificacionSAP, unidadMedidaSAP, comentarioPartida1, comentarioPartida2)
       VALUES"."(".$sql.")";
  ...
  if (!$que) {
   ...
   echo "Oferta de Venta insertada correctamente";
  }
 ?>
