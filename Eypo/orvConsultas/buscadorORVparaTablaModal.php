...
$valor = $_POST['valor'];
$sql="SELECT * FROM Pruebas15nov16.dbo.IV_EY_PV_OrdenesVentaCab WHERE FolioSAP LIKE '%$valor%' OR CodigoSN LIKE '%$valor%' OR Estatus LIKE '%$valor%' ORDER BY FolioSAP DESC";
